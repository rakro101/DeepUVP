...
HYPERPARAMETERS = {
    ...
    "momentum": 0.9,
    "model_name": "resnet34",
    "resnet18_name": "resnet18.pth",# not needed
    "load_model": True,
    "model_path": " ",
    "patience": 5,
    "num_workers": 8,
    "num_classes": 9,# Not import can be removed later
    "model_filename": "best",
    "img_size": 224,
    "continue": 0,
    "endpoint_mode": False,
    "selected_model": "resnet",
    "data_dir": "experiments/dataset012",  # dataset012"
    "predict_data_dir": "experiments/dataset015",  # "experiments/dataset015
    "number_of_test_img_save": 2000,
    "comment": "Dataset0012 + Dataset0015",
}
